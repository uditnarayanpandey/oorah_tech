...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        'Your success is our success. We partner with you to ensure every product delivers measurable results.',
    },
    {
      id: 'quality',
      title: 'Quality Excellence',
      description:
        'We maintain the highest standards in everything we do, from development to delivery and support.',
    },
    {
      id: 'transparency',
      title: 'Transparency',
      description:
        'We believe in open communication and honest relationships with all our stakeholders.',
    },
  ];
      ...
      <section className="about-hero">
        <div className="container">
          ...
          <p className="about-subtitle">
            Building innovative products that transform businesses and empower
            success.
          </p>
        </div>
      </section>
      ...
      <section className="section story">
        <div className="container">
          <div className="story-content">
            ...
            <p>
              OORAH was founded with a simple yet powerful vision: to create
              products that make a real difference in how businesses operate and
              succeed. What started as a small team of passionate innovators has
              grown into a trusted partner for companies across various
              industries.
            </p>
            <p>
              Today, we continue to uphold our founding principles while
              embracing new technologies and methodologies to deliver even
              greater value to our clients. Our journey is defined by continuous
      ...
      <section className="section values">
        <div className="container">
          ...
          <p className="values-intro">
            These core values guide everything we do at OORAH.
          </p>
      ...
      <section className="section team">
        <div className="container">
          ...
          <p className="team-intro">
            A dedicated group of leaders, builders, and creators focused on
        ...
        <div className="container">
          <div className="mission-content">
            ...
            <p>
              ...
              product solutions that drive growth, efficiency, and success in an
